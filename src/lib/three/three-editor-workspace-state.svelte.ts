/**
 * Purpose: Centralize the client-side state orchestration shared by the existing Three editor and the additive template workbench.
 * Context: Multiple editor-style routes need the same managed file loading, preview rebuild, save handling, and active-file context behavior.
