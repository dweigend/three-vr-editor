...
import { loadThreeEditorTemplateDemoData } from './editor-template-demo-load';
...
describe('loadThreeEditorTemplateDemoData', () => {
...
export const createDemoScene = () => ({ update() {}, dispose() {} });`,
		...
		const result = await loadThreeEditorTemplateDemoData({ rootDir });
